...
void home_analog_analog_clock_1_timer(lv_timer_t *timer)
{
    ...
    {
        lv_scale_set_line_needle_value(guider_ui.home_analog_analog_clock_1, guider_ui.home_analog_analog_clock_1_hour_needle, 70, home_analog_analog_clock_1_hour_value * 5);
        lv_scale_set_line_needle_value(guider_ui.home_analog_analog_clock_1, guider_ui.home_analog_analog_clock_1_min_needle, 110, home_analog_analog_clock_1_min_value);
