 ...
 * @LastEditors        : Felix
 * @LastEditTime       : 2025-03-20 22:16:22
 */
/*
* Copyright 2025 NXP
...
void setup_scr_home_analog(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_image_src(ui->home_analog, &_lock_RGB565A8_360x360, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_scale_set_label_show(ui->home_analog_analog_clock_1, false);
    ...
    lv_scale_set_line_needle_value(ui->home_analog_analog_clock_1, ui->home_analog_analog_clock_1_hour_needle, 70, home_analog_analog_clock_1_hour_value * 5);
    ...
    lv_scale_set_line_needle_value(ui->home_analog_analog_clock_1, ui->home_analog_analog_clock_1_min_needle, 110, home_analog_analog_clock_1_min_value);
    ui->home_analog_analog_clock_1_sec_needle = lv_image_create(ui->home_analog_analog_clock_1);
    lv_image_set_src(ui->home_analog_analog_clock_1_sec_needle, &_img_clockwise_sec_RGB565A8_22x150);
    lv_obj_align(ui->home_analog_analog_clock_1_sec_needle, LV_ALIGN_CENTER, 11 - 10, 75 - 18);
