...
class CustomLcdDisplay : public LcdGui240Display
{
public:
    CustomLcdDisplay(esp_lcd_panel_io_handle_t io_handle,
                     ...
                     bool mirror_y,
                     bool swap_xy)
        : LcdGui240Display(io_handle, panel_handle, width, height, offset_x, offset_y, mirror_x, mirror_y, swap_xy,
                           {
...
private:
    ...
    void InitializeGc9a01Display()
    {
        ...
        display_ = new LcdGui240Display(io_handle, panel_handle,
